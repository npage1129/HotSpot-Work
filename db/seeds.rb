...
comment1 = Comment.create(post_id: post1.id, user_id: user2.id, comment: "JC, that is not okay! I am telling on you!")
comment2 = Comment.create(post_id: post2.id, user_id: user5.id, comment: "Yethenia got a boyfriend!!!")
comment3 = Comment.create(post_id: post3.id, user_id: user4.id, comment: "Dude, where are you? I'm here too! Message me!")
comment4 = Comment.create(post_id: post4.id, user_id: user5.id, comment: "eww")
comment5 = Comment.create(post_id: post5.id, user_id: user1.id, comment: "Wait?! What? Answer my messages! I'm so mad right now!")
comment6 = Comment.create(post_id: post6.id, user_id: user3.id, comment: "Lame!!")
comment7 = Comment.create(post_id: post7.id, user_id: user1.id, comment: "I'm gonna steal your heart!")
commen8 = Comment.create(post_id: post8.id, user_id: user2.id, comment: "He's not bad Nicole! Don't be shallow! He seems like a great guy!")
comment9 = Comment.create(post_id: post9.id, user_id: user5.id, comment: "WOW! SALLY'S looking extra slick tooooonightttt!")
comment10 = Comment.create(post_id: post10.id, user_id: user3.id, comment: "YASS QUEEEEN!")