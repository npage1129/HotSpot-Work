...
return (
    ...
    <MainContent posts={posts} setPosts={setPosts} user={user} setUser={setUser} setIsAuthenticated={setIsAuthenticated} isAuthenticated={isAuthenticated} handleAddPost={handleAddPost}/>
    </div>
)
}
